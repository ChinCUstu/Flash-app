...
async function addCard() {
    ...
    if (question && answer) {
        try {
            ...
            const savedFlashcard = await fetch('https://flashcard-rel-backend.vercel.app/api/flashcards', {
                method: 'POST',
                headers: {
...
async function fetchFlashcards() {
    try {
        ...
        const response = await fetch('https://flashcard-rel-backend.vercel.app/api/flashcards');
